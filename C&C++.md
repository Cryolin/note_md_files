...
```java
//使用了垃圾回收技术,不再需要人为管理，相关的虚拟机会自动释放不需要使用的资源。
// Java
...
具体而言，C11的stl中为大家带来了3种智能指针，正确合理的使用可以有效的帮助大家管理资源，当然，在C++中使用智能指针没有像Java,python这种具备垃圾回收机制的语言那么舒适，毕竟，程序员还需要做一些额外的事情，但是，这远比传统的C或者C++更加优雅。
